...
app = Flask(__name__)
app.secret_key = "AIzaSyBLdWTlqBfftwStRbsUjdNOFk5LpDVQ0DY"  # Required for managing sessions

# Load Firebase Admin SDK credentials and initialize with Realtime Database URL
cred = credentials.Certificate("service.json")
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://jackpot-ff101-default-rtdb.asia-southeast1.firebasedatabase.app/'
})
